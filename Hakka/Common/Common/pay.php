...
class aliPay {
    ...
    public function getRequestParam($order_no, $money, $notify_url){
        $request = [
            ...
            "body" => "在线充值",
            "total_fee" => $money,
//            "notify_url" => C('webaddress').'index.php/'.$notify_url,
    ...
    public function refund($batch_no,$trade_no, $money, $notify_url){
        $result = $this->aliPayApi->refund($batch_no, $trade_no, $money, C('HTML_URL').'Admin/'.$notify_url);
        return $result;
    }
...
class WxPay{
    ...
    public function __construct()
    {
        ...
        self::$NOTIFY_URL = C('webaddress').'index.php/Home/Pay_re/wxpay';
    }
