  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          <li style="color: royalblue">新增新闻</li>
        </ol>
      </div>
    </div>
  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/News/add');?>" method="post" enctype="multipart/form-data">

          <div class="form-group">
            <label class="col-sm-3 control-label">所属分类</label>
            <div class="col-sm-6">
              <select name="clas_id" class="form-control">
                <?php if(is_array($clas)): $i = 0; $__LIST__ = $clas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="picture" type="file" accept="image/gif,image/jpeg,image/jpg,image/png" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="zan" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select class="select2" name="select[]" multiple="multiple" data-placeholder="">
                <?php if(is_array($recom)): $i = 0; $__LIST__ = $recom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><option value="<?php echo ($lists["id"]); ?>"><?php echo ($lists["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
