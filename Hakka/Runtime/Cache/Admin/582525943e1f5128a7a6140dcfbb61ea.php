...
<div class="page-container">
	<form action="<?php echo U('Admin/Agreement/telephone');?>" method="post" onsubmit="return validate_form(this)"  class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<input type="hidden" value="<?php echo ($info["id"]); ?>" name="id">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">客服电话：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="telephone" id="phone" placeholder="" value="<?php echo ($info["telephone"]); ?>" class="input-text">
            </div>
        </div>
		<div class="row cl">
