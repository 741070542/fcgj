  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Classs/add');?>" method="post">
          <div class="form-group">
            <label class="col-sm-3 control-label">上级分类</label>
            <div class="col-sm-6">
              <select name="father" class="form-control">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="sorting" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
