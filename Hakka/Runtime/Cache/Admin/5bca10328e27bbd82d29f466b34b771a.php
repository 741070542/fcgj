  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          <li style="color: royalblue">新闻动态</li>
        </ol>
      </div>
    </div>
...
jQuery(document).ready(function() {
  ...
  var table = $('#table1').DataTable({
    ...
    ajax: {url: "<?php echo U('Admin/News/lists');?>", dataType: 'json'},
    "columns": [
      {"data":"title"},
      {"data":"classname"},
//      {"data":"picture"},
      {data: null, render: function (data, type, full, meta) {
        ...
        var html = '';
        if (type = "display") {
          html = '<a href="'+full.picture+'" target="_blank"><img src="'+full.picture+'" style="width: 50px"></a>';
        }
        return html;
      }
      },
      ...
      {data: null, render: function (data, type, full, meta) {
        ...
        if (type = "display") {
          html =
                  '<a class="btn btn-success" href="/Admin/News/edit/id/'+full.id+'" >'+'<i class="fa fa-pencil"></i></a>'+ '&nbsp;&nbsp;&nbsp;'+
