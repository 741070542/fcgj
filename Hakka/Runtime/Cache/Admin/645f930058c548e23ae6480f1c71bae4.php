  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Lease/edit');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="age" value="<?php echo ($info["age"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>

          <div class="form-group">
            <label class="col-sm-3 control-label">个人成绩</label>
            <div class="col-sm-6">
              <input name="grade" value="<?php echo ($info["grade"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
