  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Life/add');?>" method="post" enctype="multipart/form-data">

          <div class="form-group">
            <label class="col-sm-3 control-label">所属分类</label>
            <div class="col-sm-6">
              <select name="lifeclas_id" class="form-control">
                <?php if(is_array($clas)): $i = 0; $__LIST__ = $clas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="consumption"  type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="img" type="file" accept="image/gif,image/jpeg,image/jpg,image/png" class="form-control" required/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="business_time" type="text" class="form-control" required/>
            </div>
          </div>
