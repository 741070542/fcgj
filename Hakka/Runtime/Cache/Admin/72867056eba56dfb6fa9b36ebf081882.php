...
jQuery(document).ready(function() {
  ...
  var table = $('#table1').DataTable({
    ...
    ajax: {url: "<?php echo U('Admin/Life/lists');?>", dataType: 'json'},
    "columns": [
      {"data":"title"},
      {"data":"consumption"},
      {"data":"phone"},
      ...
      {data: null, render: function (data, type, full, meta) {
        ...
        if (type = "display") {
          html =
                  '<a class="btn btn-success" href="/Admin/Life/edit/id/'+full.id+'" >'+'<i class="fa fa-pencil"></i></a>'+ '&nbsp;&nbsp;&nbsp;'+
