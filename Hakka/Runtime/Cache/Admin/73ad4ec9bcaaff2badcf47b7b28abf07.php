  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent <?php if(($f) == "f"): ?>nav-active active<?php endif; ?>"><a href=""><i class="fa fa-bug"></i> <span>新闻动态</span></a>
  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Message/edit');?>" method="post">

          <input type="hidden" name="mess_id" value="<?php echo ($info["id"]); ?>">

          <div class="form-group">
            <label class="col-sm-3 control-label">联系方式</label>
            <div class="col-sm-6">
              <input type="text" placeholder="<?php echo ($info["phone"]); ?>" class="form-control" disabled="" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" placeholder="<?php echo ($info["name"]); ?>" class="form-control" disabled="" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" placeholder="<?php echo ($info["source"]); ?>" class="form-control" disabled="" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" placeholder="<?php echo ($info["reservation"]); ?>" class="form-control" disabled="" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <textarea placeholder="<?php echo ($info["message"]); ?>" class="form-control" rows="5" disabled=""></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" placeholder="<?php echo ($info["time"]); ?>" class="form-control" disabled="" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <table class="table table-striped" id="table2">
                ...
                <tbody>
                <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($v["answer"]); ?></td>
                    <td><?php echo ($v["name"]); ?></td>
                    <td><?php echo ($v["time"]); ?></td>
                    <td>
                      <a style="text-decoration:none" onclick="picture_del(this,'<?php echo U('Admin/Message/deteme',array('id'=>$v['id']));?>')" href="javascript:;" >删除</a>
                    </td>
...
jQuery(document).ready(function() {
  ...
  var table = $('#table1').DataTable({
    ...
    ajax: {url: "<?php echo U('Admin/Message/lists');?>", dataType: 'json'},
    "columns": [
      {"data":"id"},
      {"data":"phone"},
      {"data":"name"},
