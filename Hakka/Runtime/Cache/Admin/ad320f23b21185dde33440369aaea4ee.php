  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Room/edit');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="tiele" type="text" value="<?php echo ($info["tiele"]); ?>" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="profile" type="text" value="<?php echo ($info["profile"]); ?>" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="floor" value="<?php echo ($info["floor"]); ?>" type="number" min="1" max="10000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="few" value="<?php echo ($info["few"]); ?>" type="number" min="1" max="10000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="addresses" value="<?php echo ($info["addresses"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="area" value="<?php echo ($info["area"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select name="type" id="type" class="form-control">
                <option value="1" <?php if(($info["type"]) == "1"): ?>selected = "selected"<?php endif; ?>>精装</option>
                <option value="2" <?php if(($info["type"]) == "2"): ?>selected = "selected"<?php endif; ?>>清水</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="family" value="<?php echo ($info["family"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="cost" value="<?php echo ($info["cost"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="small_rent" value="<?php echo ($info["small_rent"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="large_rent" value="<?php echo ($info["large_rent"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="toward" value="<?php echo ($info["toward"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="remark" value="<?php echo ($info["remark"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select name="is_recommend" id="is_recommend" class="form-control">
                <option value="1" <?php if(($info["is_recommend"]) == "1"): ?>selected = "selected"<?php endif; ?>>是</option>
                <option value="2" <?php if(($info["is_recommend"]) == "2"): ?>selected = "selected"<?php endif; ?>>否</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="click" value="<?php echo ($info["click"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="sequencing" value="<?php echo ($info["sequencing"]); ?>" type="number" min="1" max="100000000" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="file" name="img1[]" accept="image/gif,image/jpeg,image/jpg,image/png" class="form-control" />
              <a href="<?php echo ($info["img"]); ?>" target="_blank"><img src="<?php echo ($info["img"]); ?>" style="width: 50px"></a>
              首页图片(宽:425px,高:300px)
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <table class="" id="">
                <tr class="gradeA">
                <?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><td class="center">
                      <a href="<?php echo ($list["img"]); ?>" target="_blank"><img src="<?php echo ($list["img"]); ?>" style="width: 50px;height: 50px"></a>
                      <a class="" style="text-decoration:none" onClick="picture_del(this,'<?php echo U('Admin/Room/detes',array('id'=>$list['id']));?>')" href="javascript:;"><i class="fa fa-trash-o"></i></a>
                      &nbsp;&nbsp;&nbsp;
