  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Affairs/edit');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="consumption" value="<?php echo ($info["consumption"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="phone" id="phone" value="<?php echo ($info["phone"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="hours" value="<?php echo ($info["hours"]); ?>" type="text" class="form-control" required/>
            </div>
          </div>
