  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Album/edit');?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="name" type="text" value="<?php echo ($info["name"]); ?>" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input name="describe" type="text" value="<?php echo ($info["describe"]); ?>" class="form-control" required/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select name="is_en" id="is_en" class="form-control">
                <option value="1" <?php if(($info["is_en"]) == "1"): ?>selected = "selected"<?php endif; ?>>是</option>
                <option value="2" <?php if(($info["is_en"]) == "2"): ?>selected = "selected"<?php endif; ?>>否</option>
              </select>
            </div>
          </div>
