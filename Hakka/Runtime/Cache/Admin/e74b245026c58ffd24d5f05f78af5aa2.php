  ...
  <div class="contentpanel">
    ...
    <div class="panel panel-default">
      <div class="panel-body panel-body-nopadding">
        <form class="form-horizontal form-bordered" action="<?php echo U('Admin/Album/add_img');?>" method="post" enctype="multipart/form-data">

          <input type="hidden" value="<?php echo ($id); ?>" name="album_id">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="file" name="img" accept="image/gif,image/jpeg,image/jpg,image/png" class="form-control" required/>
            </div>
          </div>
