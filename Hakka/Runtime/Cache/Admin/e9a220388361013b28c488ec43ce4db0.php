      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="table-responsive">
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeA">
                <td class="center"><?php echo ($list["number"]); ?></td>
                <td class="center"><?php if(($list['fathers']) == "2"): ?>&nbsp;&nbsp;&nbsp;--<?php endif; echo ($list["classname"]); ?></td>
                <td class="center">
                  <?php switch($list["type"]): case "1": ?>是<?php break;?>
                    <?php case "2": ?>否<?php break;?>
                    <?php default: endswitch;?>
                </td>
                <td class="center"><?php echo ($list["url"]); ?></td>
                <td class="center">
                  <?php switch($list["is_an"]): case "1": ?>是<?php break;?>
                    <?php case "2": ?>否<?php break;?>
                    <?php default: endswitch;?>
                </td>
                <td class="center"><?php echo ($list["sorting"]); ?></td>
                <td class="center">
                  <a class="btn btn-success" href="<?php echo U('Admin/Classs/edit',array('id'=>$list['id']));?>"><i class="Hui-iconfont"><i class="fa fa-pencil"></i></i></a>
                  &nbsp;&nbsp;
                  <a class="btn btn-danger" style="text-decoration:none" onClick="picture_del(this,'<?php echo U('Admin/Classs/lists',array('id'=>$list['id']));?>')" href="javascript:;"><i class="fa fa-trash-o"></i></a>
                </td>
