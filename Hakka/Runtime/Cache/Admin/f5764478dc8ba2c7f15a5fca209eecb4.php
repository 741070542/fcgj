  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          <li style="color: royalblue">租代顾问</li>
        </ol>
      </div>
    </div>
...
jQuery(document).ready(function() {
  ...
  var table = $('#table1').DataTable({
    ...
    ajax: {url: "<?php echo U('Admin/Lease/lists');?>", dataType: 'json'},
    "columns": [
      {"data":"name"},
      {"data":"phone"},
      {"data":"age"},
      ...
      {data: null, render: function (data, type, full, meta) {
        ...
        if (type = "display") {
          html =
                  '<a class="btn btn-success" href="/Admin/Lease/edit/id/'+full.id+'" >'+'<i class="fa fa-pencil"></i></a>'+ '&nbsp;&nbsp;&nbsp;'+
