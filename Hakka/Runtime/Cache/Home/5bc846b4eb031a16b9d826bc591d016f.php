...
<head lang="en">
    ...
    <script id="template" type="x-tmpl-mustache">
        {{#DataList}}
            <li>
                <a href="/Home/Life/busation/id/{{{id}}}">
                <img src="{{{img}}}" alt="">
    ...
    <div class="company-list">
        <ul>
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><li>
                <a class="load" href="/Home/Life/busation/id/<?php echo ($lists["id"]); ?>">
...
<script>
    wx.config({
        ...
        timestamp: '1512025040', // 必填，生成签名的时间戳
        nonceStr: 'xtjvbayguhaylyn', // 必填，生成签名的随机串
        signature: 'aef70e3cd38792c1d752a0a3bcf7c8a98fb3d255',// 必填，签名，见附录1
        jsApiList: [
            'onMenuShareTimeline',
