...
<div class="container" style="overflow:hidden;">
    ...
    <div class="a-share clearfix">
        ...
        <a class="a-s-zan" style="position:relative"  href="javascript:great(50);">
...
<!--公用底部-->
<div class="bk5"></div>
<a href="/Home/corr/gywm/clid/9" class="fx-logo ripplelink  load">
...
<script>
    wx.config({
        ...
        timestamp: '1511852198', // 必填，生成签名的时间戳
        nonceStr: 'cufadtoetbwzkks', // 必填，生成签名的随机串
        signature: '0a37d6af13f54ad7b8f9639f095bed47032dedac',// 必填，签名，见附录1
        jsApiList: [
            'onMenuShareTimeline',
    ...
    if (ua.match(/MicroMessenger/i) == "micromessenger") {
        ...
        wx.ready(function () {
            wx.onMenuShareAppMessage({
                title: '关于复星-复城国际T1咨询',
                desc: '关于复星-复城国际T1咨询',
                link: 'http://fcgj.pthola.cn/newdetail?id=50',
                imgUrl: url + '/UploadFolder/2016-01-28/2016012817581833899653.png',
